...
export class Snake extends AcGameObject {
    ...
    check_tail_increasing() { // 检测当前回合，蛇的长度是否增加。前十回合每回合都变长，后面每三步长一步
...
//走到目标点了
    ...
    render() {
        ...
        for (let i = 1; i < this.cells.length; i ++) {
            ...
            if (Math.abs(a.x - b.x) < this.eps && Math.abs(a.y - b.y) < this.eps) //特判一下，如果特别接近，可以忽略矩形宽度
                continue;
